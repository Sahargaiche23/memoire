...
import { Send, Search, Plus, Users, Phone, Video, Image, File, Smile, MoreVertical, X, MessageCircle, Paperclip } from 'lucide-react';
              ...
              filteredConversations.map(conv => (
                ...
                >
                  <div className="conversation-avatar">
                    {conv.lastMessage.sender_name.charAt(0).toUpperCase()}
                  </div>
                  <div className="conversation-content">
                    <h4>{conv.lastMessage.sender_name}</h4>
            ...
            <>
              ...
              <div className="chat-header">
                <div className="chat-header-info">
                  <h3>{selectedConversation.lastMessage.sender_name}</h3>
